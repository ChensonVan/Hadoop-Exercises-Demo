...
//        		int RID = Integer.parseInt(itr.nextToken());
        		itr.nextToken();
...
//        	assume the input file is sorted 
//        	if(itr.countTokens() > 1) {
//        		itr.nextToken();
...
//        			System.out.println("str2 = " + str2);
        			...
        			if(similarity >= SIM) {
        				if(RID1 < RID2) {
//        					context.write(new IntPair(RID1, RID2), new DoubleWritable(similarity));
        					context.write(new Text(RID1 + "\t" + RID2), new DoubleWritable(similarity));
        				} else if (RID1 > RID2) {
//        					context.write(new IntPair(RID2, RID1), new DoubleWritable(similarity));
...
//        		System.out.println("RID1 = " + RID1 + "; RID2 = " + RID2 + "; SIM = " + similarity); 
        	}
